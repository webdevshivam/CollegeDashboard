  ...
  return (
    <div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white">{stats.gallery}</p>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="card-hover transition-all duration-300">
          <CardContent className="p-6">
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Add New Faculty</h4>
        ...
        <Card className="card-hover transition-all duration-300">
          <CardContent className="p-6">
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Upload Banner</h4>
        ...
        <Card className="card-hover transition-all duration-300">
          <CardContent className="p-6">
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Publish Notice</h4>
